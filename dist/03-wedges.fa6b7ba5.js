...
function ready(datapoints) {
  ...
  svg.append('circle').attr('r', 3).attr('cx', 0).attr('cy', 0).attr('fill', 'black');
  svg.append('text').style('font-size', '24').attr('text-anchor', 'middle').text('NYC high temperatures, by month').attr('x', 0).attr('y', -120);
}
